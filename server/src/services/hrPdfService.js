...
export function generateSalarySlipPdf(slip) {
  return new Promise((resolve, reject) => {
    ...
    doc.roundedRect(LEFT, y + 112, CONTENT_WIDTH, 88, 10).fill("#fffaf0").strokeColor("#f4d48c").stroke();
    doc.fillColor(teal).font("Helvetica-Bold").fontSize(8).text("CONFIDENTIAL PAYROLL NOTICE", 58, y + 129, { lineBreak: false });
    doc.fillColor(ink).font("Helvetica").fontSize(8.2).text(slip.notes || "This document is generated by Innovex Resource Group Limited for payroll record purposes. Please contact the finance team if any details require review.", 58, y + 148, { width: 470, lineGap: 2 });
