...
export default function InterviewForm({ form, setForm, editing, saving, onSubmit, onCancel }) {
  ...
  return (
    <form className="card form interview-form" onSubmit={onSubmit}>
      ...
      <label className="checkbox-line"><input type="checkbox" checked={form.reminderEmailEnabled} onChange={(e) => setForm({ ...form, reminderEmailEnabled: e.target.checked })} /> Reminder email enabled</label>
