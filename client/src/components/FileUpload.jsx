...
export default function FileUpload({ name = "cv", required = false, label = "Upload CV", helper = "Secure PDF or DOCX up to 5MB", prompt = "Choose or drag your CV here", accept = ".pdf,.docx" }) {
