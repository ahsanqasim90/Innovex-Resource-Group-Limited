...
export const rolePresets = {
  recruitment: ["dashboard.view", "attendance.view", "recruitmentPipeline.view", "recruitmentPipeline.submit", "jobs.view", "jobs.create", "jobs.edit", "jobs.export", "applications.view", "applications.edit", "applications.export", "cvs.view", "cvs.edit", "talentPool.view", "talentPool.create", "talentPool.edit", "talentPool.export", "talentPool.send", "candidateCvs.view", "calls.view", "calls.create", "calls.edit", "interviews.view", "interviews.create", "interviews.edit", "interviews.send", "meetings.view", "meetings.create", "meetings.edit", "meetings.send", "terms.view", "terms.manage", "clients.view", "compliance.view", "compliance.manage", "automations.view", "automations.execute", "reports.view", "portals.manage"],
  sales: ["dashboard.view", "attendance.view", "businessLeads.view", "businessLeads.create", "businessLeads.edit", "businessLeads.export", "businessLeads.send", "emails.view", "emails.create", "emails.edit", "emails.send", "newsletters.view", "calls.view", "calls.create", "calls.edit", "calls.export", "meetings.view", "meetings.create", "meetings.edit", "meetings.send", "terms.view", "terms.manage", "courses.view", "courses.create", "courses.edit", "trainingBookings.view", "trainingBookings.create", "trainingBookings.edit", "trainingBookings.export", "trainingQuotations.view", "trainingQuotations.manage", "clients.view", "clients.manage", "automations.view", "portals.manage"],
  training: ["dashboard.view", "attendance.view", "courses.view", "courses.create", "courses.edit", "trainingBookings.view", "trainingBookings.create", "trainingBookings.edit", "trainingBookings.export", "trainingQuotations.view", "trainingQuotations.manage", "meetings.view", "meetings.create", "meetings.edit", "meetings.send", "terms.view", "terms.manage", "businessLeads.view", "automations.view"],
  marketing: ["dashboard.view", "attendance.view", "businessLeads.view", "businessLeads.create", "businessLeads.edit", "businessLeads.export", "emails.view", "emails.create", "emails.edit", "emails.send", "newsletters.view", "newsletters.manage", "blogs.view", "blogs.create", "blogs.edit", "blogs.approve", "testimonials.view", "testimonials.edit", "testimonials.approve", "partners.view", "partners.create", "partners.edit", "contacts.view", "contacts.manage"],
...
export function hasPermission(user, permission) {
  ...
  if (user?.permissions?.includes(`${moduleName}.manage`)) return true;
  return action === "view" && Boolean(user?.permissions?.some((value) => value.startsWith(`${moduleName}.`)));
}
